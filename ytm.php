...
$view_timestamp = date("Y.m.d. - H:i", strtotime($view_timestamp));
...
$text .= "$first$prev " . LAN_YTM_PAGE_3 . " <strong>$maxPage </strong>&nbsp;&nbsp;" . LAN_YTM_PAGE_4 . " <strong>$pageNum </strong>$next$last";
