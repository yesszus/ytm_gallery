...
$text .= r_userclass("submit_class",$store_subm_class,$e_userclass = $uclass,'public, guest, nobody, member, main, admin, mods, classes, no-excludes' );
$text .="</td></tr>";

$text .= "
<tr><td style='width:30%' class='forumheader3'>$rc_dislan</td>
<td style='width:70%' class='forumheader3'>";
$text .= r_userclass("ytm_rate_class",$store_rate_class,$e_userclass = $uclass,'public, guest, nobody, member, main, admin, mods, classes, no-excludes' );
//$text .= r_userclass("ytm_rate_class",$store_rate_class, $optlist = 'public, guest, nobody, member, admin, classes' );
$text .="&nbsp;<img src='". e_PLUGIN . "ytm_gallery/images/docs_16.png' title='" . LAN_YTM_PREFS_45 . "' border='0' /></td></tr>";
...
</select><br /><br />". LAN_YTM_PREFS_34a . "</td></tr>";
...
</select>&nbsp;<img src='". e_PLUGIN . "ytm_gallery/images/docs_16.png' title='" . LAN_YTM_PREFS_48 . "' border='0' /></td></tr>";
...
</select>&nbsp;<img src='". e_PLUGIN . "ytm_gallery/images/docs_16.png' title='" . LAN_YTM_PREFS_26 . "' border='0' /></td></tr>";
...
$text .="</select>&nbsp;<img src='". e_PLUGIN . "ytm_gallery/images/docs_16.png' title='" . LAN_YTM_PREFS_27 . "' border='0' /></td></tr>";
...
$text .= r_userclass("bb_class",$store_bb_class,$e_userclass = $uclass,'public, guest, nobody, member, main, admin, mods, classes, no-excludes' );
