...
</td></tr><font color='red'>$msgtext</font><tr><td><br></td></tr>";

$text .= "
<tr><td style='width:30%' class='forumheader3'>** $codedislan</td>
<td style='width:70%' class='forumheader3'><input class='tbox' type='text' name='submit_code' value='$codevalue' size='60' maxlength='100' />&nbsp;<img src='". e_PLUGIN . "ytm_gallery/images/docs_16.png' title='" . LAN_YTM_MOVIE_PREFS_11 . "' border='0' />
...
<input class='tbox' type='HIDDEN' name='submit_check' value='1' size='1' maxlength='1' /><br /><br />
<b>".LAN_YTM_SUBM_PREFS_62."</b><br />".LAN_YTM_SUBM_PREFS_63."</td></tr>";
