...
<td style='width:70%' class='forumheader3'><input class='tbox' type='text' name='edit_code' value='$edit_movie_code' size='60' maxlength='100' />
...
$text .= "<center><img src='". e_PLUGIN . "ytm_gallery/images/nopreview.png' border='0' />";
...
$store_movie_title = str_replace ("'","&#39;",$store_movie_title);
$store_movie_code = $_POST['edit_code'];
...
$store_movie_acti  = $_POST['edit_active'];
      ...
      mysql_query("update ".MPREFIX."er_ytm_gallery_movies set movie_title = '$store_movie_title', movie_code= '$store_movie_code' , movie_category = '$store_movie_cat', active = '$store_movie_acti'  WHERE movie_id = '$store_movie_id';");
...
$text .= "
<tr><td style='width:30%' class='forumheader3'>" . LAN_YTM_PREFS_0 . "</td>
<td style='width:70%' class='forumheader3'><input class='tbox' type='text' name='submovie_code' size='60' maxlength='100' />&nbsp;<img src='". e_PLUGIN . "ytm_gallery/images/docs_16.png' title='" . LAN_YTM_MOVIE_PREFS_11 . "' border='0' />
</td></tr>";
