...
$text .= r_userclass("edit_cat_auth",$edit_cat_auth,$e_userclass = $uclass,'public, guest, nobody, member, main, admin, mods, classes, no-excludes' );
...
$text .= r_userclass("subcat_auth", '0', $e_userclass = $uclass,'public, guest, nobody, member, main, admin, mods, classes, no-excludes' );
$text .= "</td></tr>";
...
<a href='" . e_SELF . "?edit=$cat_id' title=' ". LAN_YTM_CAT_PREFS_16 ." '><img src='". e_IMAGE_ABS . "admin_images/edit_16.png' border='0' /></a>
<a href='" . e_SELF . "?delete=$cat_id' title=' ". LAN_YTM_CAT_PREFS_8 ." '><img src='". e_IMAGE_ABS . "admin_images/delete_16.png' border='0' /></a>
";
$text .= "</td></tr>";
$cat_i++;
}
