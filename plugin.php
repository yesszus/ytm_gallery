...
"INSERT INTO ".MPREFIX."er_ytm_gallery (title_gallery, title_form, title_menu, title_rating, title_tp, submit_class, submit_text, random_menu, movie_colum, movie_row, menu_width, menu_height, bb_class, gal_order, version, disp_title, ap_submit, disp_search, disp_download, short_title, short_title_count, ytm_rate_class, disp_rate) VALUES ('" . LAN_YTM_PLUGIN_9 . "', '" . LAN_YTM_PLUGIN_10 . "', '" . LAN_YTM_PLUGIN_11 . "', '". LAN_YTM_PLUGIN_13 . "', '". LAN_YTM_PLUGIN_14 . "', '0', '" . LAN_YTM_PLUGIN_12 . "', '1', '3', '4', '150', '150', '0', '1', '$eplug_version', '0', '1', '0', '1', '0', '20', '0', '0');",
"INSERT INTO ".MPREFIX."er_ytm_gallery_category (cat_name, cat_auth) VALUES ('". LAN_YTM_PLUGIN_8 . "', '0');",
"INSERT INTO ".MPREFIX."er_ytm_gallery_movies (movie_title, movie_code, movie_category, active, input_user, input_email, input_way, input_status) VALUES ('" . LAN_YTM_PLUGIN_7 . "', 'qhN4T4uhIWE', '1', '1', '" . LAN_YTM_PLUGIN_115 . "', '" . LAN_YTM_PLUGIN_1 . "', '1', '1');");
